...
export default function LunchPage() {
  ...
  return (
    <div className="py-14 px-2 sm:px-6 max-w-4xl mx-auto bg-linear-to-b from-neutral-50 to-neutral-100 dark:from-neutral-950 dark:to-neutral-900">
      ...
      <div className="overflow-x-auto rounded-xl shadow-lg border border-neutral-200 dark:border-neutral-700">
        <div className="min-w-full bg-linear-to-b from-neutral-50 to-neutral-100 dark:from-neutral-950 dark:to-neutral-900 p-4">
